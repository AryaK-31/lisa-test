...
export default function LDSForm() {
  const [formData, setFormData] = useState({
    ...
    // Abuse details
    wasAbused: "",
    abuseTypes: [], // ✅ enum values
    abuseDate: "",
    whoInvolved: "",
    abuseOutcomes: [], // ✅ enum values
    abuseLocations: [], // ✅ enum values
    abuseContext: "",
  ...
  async function handleSubmit(e) {
    ...
    const payload = {
      ...
      // LDS Abuse Report fields
      dateOfAbuse: formData.abuseDate,
      wasAbused: formData.wasAbused === "yes",
      incidentTypes: formData.abuseTypes, // ✅ enum values
      incidentOutcomes: formData.abuseOutcomes, // ✅ enum values
      abuseLocations: formData.abuseLocations, // ✅ enum values
  ...
  return (
    <div className="form-page">
      <h2>Create LDS</h2>
      <form className="lds-form" onSubmit={handleSubmit}>
        {/* Row 1 */}
        ...
        <div className="form-row">
          ...
          <div className="form-group">
            <label>What type of LDS-related incident are you reporting?</label>
    ...
    {[
      ...
      <div key={item.value}>
        ...
        <div className="form-row">
          ...
          <div className="form-group">
            <label>Have you ever spoken to a therapist about this?</label>
            <div>
              <input
                type="radio"
